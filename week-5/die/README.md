...
## Summary
Working off your previous `Die` class from [Die Class 1](https://github.com/Devbootcamp/phase-0-unit-2/tree/master/week-4/die-class), implement a new `Die` class which takes an array of strings as its input.  When `Die#roll` is called, it randomly returns one of these strings.  If `Die.new` is passed an empty array, raise an `ArgumentError`.  It should work like this:
