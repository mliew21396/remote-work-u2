...
## Release 3: Test!
Write tests using [Driver Test Code](https://github.com/Devbootcamp/phase_0_handbook/blob/master/coding-references/driver-code.md) or `assert` statements (make sure you have your assert method defined!)
